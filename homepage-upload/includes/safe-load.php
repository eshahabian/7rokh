...
function casting_safe_fail_page(string $title, string $detail = ''): void
{
    ...
    echo '<p>اگر تازه فایل آپلود کرده‌اید، همان فایل را کامل از این ریپو دوباره بفرستید.</p>';
    echo '<p><a href="portal-health.php?key=7rokh-health">گزارش سلامت فایل‌ها</a> · <a href="login.php">ورود</a></p>';
    echo '</body></html>';
    exit;
}

...
function casting_faq_items(): array
{
    return [
        [
            'question' => '۷ رخ چیست؟',
            'answer'   => '۷ رخ پورتال تخصصی سینما و تئاتر است؛ بستری برای معرفی هنرمندان و برقراری ارتباط حرفه‌ای میان بازیگران، عوامل تولید، کارگردان‌ها و تهیه‌کنندگان.',
        ],
        [
            'question' => 'آیا استفاده از ۷ رخ رایگان است؟',
            'answer'   => 'عضویت و استفاده از امکانات اصلی پورتال رایگان است. برای اولویت در جستجو و حساب کاربری ویژه می‌توانید بسته ۳، ۶ یا ۱۲ ماهه تهیه کنید.',
        ],
        [
        ...
        [
            'question' => 'چه کسانی می‌توانند در ۷ رخ عضو شوند؟',
        ...
        [
            ...
            'answer'   => 'با فعال‌سازی حساب ویژه، پروفایل شما در نتایج جستجو در اولویت نمایش داده می‌شود و به امکانات ویژه دسترسی دارید. پس از پرداخت موفق آنلاین، همان بستهٔ انتخابی (۳، ۶ یا ۱۲ ماهه) بلافاصله و خودکار فعال می‌شود؛ نیازی به تأیید دستی مدیر نیست.',
        ],
        [
        ...
        [
            ...
            'answer'   => 'از بخش «تماس با ما» در منو می‌توانید بدون ورود پیام بفرستید. گیرنده را انتخاب کنید (مدیر سایت یا مدیر ۷ رخ)؛ پیام داخل پنل کاربری ثبت می‌شود.',
        ],
        [
            'question' => 'آیا می‌توانم پیام‌هایم را مشاهده کنم؟',
            'answer'   => 'بله. پس از ورود، از بخش «پیام‌ها» در پنل می‌توانید ببینید چه کسانی به شما پیام داده‌اند و گفتگو را ادامه دهید.',
        ],
        [
            'question' => 'آیا ۷ رخ روی موبایل هم قابل استفاده است؟',

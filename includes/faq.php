...
function casting_faq_items(): array
{
    return [
        [
            'question' => '7 رخ چیست؟',
            'answer'   => '7 رخ پورتال تخصصی سینما و تئاتر است؛ بستری برای معرفی هنرمندان و برقراری ارتباط حرفه‌ای میان بازیگران، عوامل تولید، کارگردان‌ها و تهیه‌کنندگان.',
        ],
        [
            'question' => 'آیا استفاده از 7 رخ رایگان است؟',
        ...
        [
            'question' => 'چه کسانی می‌توانند در 7 رخ عضو شوند؟',
        ...
        [
            ...
            'answer'   => 'از بخش «تماس با ما» در منو می‌توانید بدون ورود پیام بفرستید. گیرنده را انتخاب کنید (مدیر سایت یا مدیر 7 رخ)؛ پیام داخل پنل کاربری ثبت می‌شود.',
        ],
        [
        ...
        [
            'question' => 'آیا 7 رخ روی موبایل هم قابل استفاده است؟',

...
casting_render_panel_start('ارسال پوستر', 'my-ads');
casting_render_flash();
?>
<section class="dash-card">
  <?php casting_render_panel_heading('ارسال پوستر تبلیغ'); ?>
  <p class="lede">پس از پرداخت، پوستر را بفرستید. تا تأیید مدیران (eshahabian و ardavan) در بنر تبلیغات صفحه اصلی دیده نمی‌شود. فقط پوسترهای خودتان را می‌بینید.</p>
              ...
              <?php if ($is_editing) : ?>
                <form class="form" method="post" enctype="multipart/form-data" action="my-ads.php">
                  ...
                  <div class="cta-row">
                    ...
                    <a class="btn btn-ghost btn-sm" href="my-ads.php">انصراف</a>
                  </div>
                </form>
              <?php else : ?>
                <a class="btn btn-primary btn-sm" href="my-ads.php?edit=<?= (int) $item['id'] ?>">اصلاح و ارسال مجدد</a>
              <?php endif; ?>
            <?php endif; ?>
          </div>
        </article>
